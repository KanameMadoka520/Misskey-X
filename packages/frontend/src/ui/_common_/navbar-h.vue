...
<div :class="[$style.root, acrylic ? $style.acrylic : null]">
	<div :class="$style.body">
		<div>
			...
			<MkA v-click-anime v-tooltip="i18n.ts.tangcuyuServerUpdates" :class="$style.item" :activeClass="$style.active" :to="TANGCUYU_SERVER_UPDATES_PATH">
				<i :class="$style.itemIcon" class="ti ti-fish ti-fw"></i>
			</MkA>
