...
export type AdminEmailAuditListRequest = operations['admin___email-audit___list']['requestBody']['content']['application/json'];
export type AdminEmailAuditListResponse = operations['admin___email-audit___list']['responses']['200']['content']['application/json'];
...
export type ChannelsFeaturedRequest = operations['channels___featured']['requestBody']['content']['application/json'];
...
export type ChannelsUsersRequest = operations['channels___users']['requestBody']['content']['application/json'];
export type ChannelsUsersResponse = operations['channels___users']['responses']['200']['content']['application/json'];
...
export type EmailQuotaResponse = operations['email___quota']['responses']['200']['content']['application/json'];
...
export type NotesWaterfallRequest = operations['notes___waterfall']['requestBody']['content']['application/json'];
export type NotesWaterfallResponse = operations['notes___waterfall']['responses']['200']['content']['application/json'];
